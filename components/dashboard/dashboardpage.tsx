            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-foreground font-medium truncate block">{user.email}</span>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-foreground font-medium truncate block">{user.full_name}</span>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <span className="text-sm text-muted-foreground block">Current Date:</span>
                  <span className="text-foreground font-medium text-sm">{currentDate}</span>
                </div>
              </motion.div>
            </div>
          </div>
