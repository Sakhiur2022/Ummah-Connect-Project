...
function Leaderboard() {
  ...
  return (
    <motion.div className="relative bg-linear-to-br from-slate-900 via-purple-950 to-slate-900 border-2 border-purple-500/30 rounded-2xl p-5 shadow-2xl overflow-hidden">
        ...
        {leaders.map((l) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-10 h-10 rounded-full bg-linear-to-br ${getRankColor(l.rank!)} flex items-center justify-center font-bold text-white`}
              >
            ...
            <div className="font-bold text-lg bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              {l.score} pts
            </div>
          </li>
        ))}
...
function IbadahDashboard({ userId }: { userId: string }) {
  ...
  return (
    <motion.div className="relative bg-linear-to-br from-slate-900 via-blue-950 to-slate-900 border-2 border-blue-500/30 rounded-2xl p-6 shadow-2xl overflow-hidden mb-6">
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-blue-950 to-slate-950 p-6 space-y-6 text-white relative overflow-hidden">
      <motion.div className="flex justify-between items-center mb-6">
        <h1 className="text-4xl font-bold bg-linear-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">Dashboard</h1>
        <motion.button className="px-5 py-2.5 bg-linear-to-r from-red-600 to-red-700 text-white rounded-xl font-semibold shadow-lg flex items-center gap-2"><LogOut className="w-4 h-4" /> Logout</motion.button>
      </motion.div>
